...
SECTIONS = {
    ...
    "commands": {
        ...
        "text": (
            ...
            "• <code>افزودن فیلتر [کلمه/عبارت]</code> / <code>حذف فیلتر [کلمه/عبارت]</code> / "
            "<code>لیست فیلتر</code> → حذف خودکار پیامی که این کلمه/عبارت را <b>کامل</b> داشته باشد "
            "(نه هر کلمه‌ای که فقط شاملش باشد؛ مثلاً فیلتر «خر» باعث حذف «خرگوش» نمی‌شود) - جدا از «قفل فحش»\n"
