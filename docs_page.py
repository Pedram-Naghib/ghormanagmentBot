...
<section id="moderation">
  ...
  <table>
    ...
    <tr><td><code>کیک</code> / <code>بن</code> / <code>اخراج</code> / <code>سیک</code></td><td>اخراج + بن دائم از گروه (تا «رفع بن») + یک جمله‌ی شوخی رندوم</td><td>ریپلای + دقیقاً این کلمه، یا <code>بن @username</code></td></tr>
