...
<section id="spam">
  ...
  <p>پیش‌فرض: <b>خاموش</b>. از یک دیتاست عمومی فحش فارسی استفاده می‌کند که گسترده است و ممکن است گاهی کلمات بی‌گناه را هم بگیرد (مثلاً اسم حیوانات یا اقوام که گاهی به‌عنوان توهین هم استفاده می‌شوند) - برای همین پیش‌فرضش خاموش است و باید از پنل روشن شود.</p>
  <table>
    <tr><th>دستور</th><th>کار</th></tr>
